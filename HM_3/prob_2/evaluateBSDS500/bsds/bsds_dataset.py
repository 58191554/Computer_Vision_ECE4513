...
class BSDSHEDAugDataset (object):
    ...
    AUG_SCALES = ['', '_scale_0.5', '_scale_1.5']

    AUG_ROTS = ['0.0', '22.5', '45.0', '67.5', '90.0', '112.5', '135.0', '157.5', '180.0', '202.5', '225.0', '247.5', '270.0', '292.5', '315.0', '337.5']
    ...
    def load_mean_boundaries(path):
        ...
        return cv2.cvtColor(img_as_float(imread(path)),cv2.COLOR_BGR2GRAY).astype(np.float32)
