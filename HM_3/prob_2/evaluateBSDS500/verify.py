...
for sample_index, res in enumerate(sample_results):
    print('index: {:<10d} threshold: {:<10.6f} recall: {:<10.6f} precision: {:<10.6f} f1: {:<10.6f}'.format(
...
for thresh_i, res in enumerate(threshold_results):
    print('threshold: {:<10.6f} recall: {:<10.6f} precision: {:<10.6f} f1: {:<10.6f}'.format(
        res.threshold, res.recall, res.precision, res.f1))

print('')
print('Summary:')
print('threshold: {:<10.6f} recall: {:<10.6f} precision: {:<10.6f} f1: {:<10.6f} best_recall: {:<10.6f} best_precision: {:<10.6f} best_f1: {:<10.6f}'
      'area_pr: {:<10.6f}'.format(
